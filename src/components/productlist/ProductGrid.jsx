...
const ProductGrid = ({
  ...
  return (
    <div className="catalog-grid d-flex flex-column flex-fill">
      <div className="d-flex justify-content-between align-items-center pb-3 gap-2 flex-wrap">
        <ActiveFilterTags
          activeFilters={activeFilters}
          toggleFilter={toggleFilter}
        />
        <div className="d-flex align-items-center gap-2">
          <span className="small text-secondary">Sắp xếp:</span>
          <select
